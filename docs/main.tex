...
\newcommand{\coursename}{AUTONOMNA VOZILA}
\newcommand{\seminartitle}{Uloga normi ISO 26262 i ISO 21448 (SOTIF) u osiguravanju sigurnosti sustava automatizirane vožnje}
\newcommand{\seminartitleshort}{ISO 26262 i ISO 21448 u automatiziranoj vožnji}
\newcommand{\professorname}{prof. dr. sc. Joško Deur, izv. prof. dr. sc. Mario Hrgetić, izv. prof. dr. sc. Branimir Škugor, izv. prof. dr. sc. Marko Švaco}
...
\begin{titlepage}
  ...
  \begin{tabular}{p{0.45\textwidth}>{\raggedleft\arraybackslash}p{0.45\textwidth}}
    \textmd{Profesori:} & \textmd{Student:} \\[0.3cm]
...
\input{chapters/ads-percepcija}

\input{chapters/01-iso26262}

\input{chapters/02-sotif}

\input{chapters/03-usporedba}
